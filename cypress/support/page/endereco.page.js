class EnderecoPage{
    ...
    editarEnderecoFaturamento(nome, sobrenome, empresa, pais, rua, numero, cidade, estado, cep, telefone, email) {
        ...
        cy.get('#select2-billing_country-container').click().type(pais).get('[role="option"]').click()
    ...
    editarEnderecoEntrega(nome, sobrenome, empresa, pais, rua, numero, cidade, estado, cep) {
        ...
        cy.get('#select2-shipping_country-container').click().type(pais).get('[role="option"]').click()
